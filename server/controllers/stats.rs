use crate::models::{
    ...
    AuthUser, MonthStat, Page, Pageview, Referrer, Stats, Website,
};
use crate::utils::Db;
...
pub async fn get_stat(
    ...
    let (website, months, pageviews): (Website, Vec<MonthStat>, Vec<Pageview>) =
